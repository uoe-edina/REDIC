...
<!--[if (gte IE 9)|!(IE)]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url(); ?>theme/default/css/style.css?v=2">
		<!-- uoalibrary/css/style.css?v=2">  -->
	...
	<body>
		...
		<div id="container">
			...
			<header>
				...
				<a href="http://www.ed.ac.uk/" class="logo">University of Edinburgh</a>
