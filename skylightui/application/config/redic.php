<?php
    ...
    $config['skylight_objectproxy_url'] = 'https://localhost:8080/xmlui/bitstream/handle/123456789/';

    // The URL base for where digital objects can be proxied from
    //$config['skylight_objectproxy_url'] = 'http://dlib-pegasus.ucs.ed.ac.uk:8080/xmlui/bitstream/handle/123456789/';
