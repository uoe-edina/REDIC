<?php
    ...
    $config['skylight_objectproxy_url'] = 'http://localhost:8080/xmlui/bitstream/handle/123456789/';
    ...
    $config['skylight_bitstream_field'] = 'superindex.bitstream.original.en';
    $config['skylight_thumbnail_field'] = 'superindex.bitstream.thumbnail.en';
