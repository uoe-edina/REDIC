...
<html>
	...
	<body>
		<a href="#create-equipmentItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-equipmentItem" class="content scaffold-create" role="main">
